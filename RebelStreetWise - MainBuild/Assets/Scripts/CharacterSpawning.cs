            ...
            switch(i)
            {
                ...
                case 1:
                    if (playerOne != null)
                    {
                        ...
                        player1.GetComponent<PlayerInfo>().playerHealth = 1;
                ...
                case 2:
                    if (playerTwo != null)
                    {
                        ...
                        player2.GetComponent<PlayerInfo>().playerHealth = 100;
                ...
                case 3:
                    if (playerThree != null)
                    {
                        ...
                        player3.GetComponent<PlayerInfo>().playerHealth = 100;
                ...
                case 4:
                    if (playerOne != null)
                    {
                        ...
                        player4.GetComponent<PlayerInfo>().playerHealth = 100;
